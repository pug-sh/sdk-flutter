...
| Tracking consent | `optIn/optOut/getConsent/isTrackingEnabled`, `trackingConsent` option, persist | Same API and gating; `TrackingConsentConfig` with persist | Complete |
